 ...
 * @since   LingPipe1.0
 */
class SidIndoEuropeanTokenizer extends Tokenizer {
     ...
     * out of bounds.
     */
    public SidIndoEuropeanTokenizer(char[] ch, int offset, int length) {
     ...
     */
    public SidIndoEuropeanTokenizer(String chars) {
     ...
     */
    public SidIndoEuropeanTokenizer(StringBuilder chars) {
        this(chars.toString());
    }
    ...
    public static String[] tokenize(String phrase) {
        return new SidIndoEuropeanTokenizer(phrase).tokenize();
    }
