...
/**
 * An <code>SidIndoEuropeanTokenizerFactory</code> creates tokenizers
 ...
 * @since   LingPipe1.0
 */
public class SidIndoEuropeanTokenizerFactory
    ...
    public static final TokenizerFactory INSTANCE
        = new SidIndoEuropeanTokenizerFactory();
     ...
     */
    @Deprecated
    public SidIndoEuropeanTokenizerFactory() {
        /* do nothing */
    }
    ...
    public Tokenizer tokenizer(char[] ch, int start, int length) {
        return new SidIndoEuropeanTokenizer(ch,start,length);
    }
