...
public class CorrelationInteractions {
	...
	public static void main(String[] args) {
		try {
			...
			for (String txtFile : txtFiles) {
				...
				PrintWriter pwr = new PrintWriter(new FileWriter("../RESULTS_correlation/"+txtFile.substring(0,txtFile.length()-3)+"res"));
	...
	private static String findInteraction(String contestant) {
		...
		Sid.log("\t"+contestant);
		boolean skip=true;
		if(ent1Type.equals("PROBLEM_")&&ent2Type.equals("PROBLEM_"))
			return "1"+"||"+"averaged"+"||"+sortedConcepts.get(ent1)+"||r=\""+"PIP"+"\"||"+sortedConcepts.get(ent2);
		else if(ent1Type.equals("TREATMENT_")&&ent2Type.equals("PROBLEM_"))
			return "1"+"||"+"averaged"+"||"+sortedConcepts.get(ent1)+"||r=\""+"TrAP"+"\"||"+sortedConcepts.get(ent2);
		else if(ent2Type.equals("TREATMENT_")&&ent1Type.equals("PROBLEM_"))
			return "1"+"||"+"averaged"+"||"+sortedConcepts.get(ent2)+"||r=\""+"TrAP"+"\"||"+sortedConcepts.get(ent1);
		else if(ent1Type.equals("TEST_")&&ent2Type.equals("PROBLEM_"))
			return "1"+"||"+"averaged"+"||"+sortedConcepts.get(ent1)+"||r=\""+"TeRP"+"\"||"+sortedConcepts.get(ent2);
		else if(ent2Type.equals("TEST_")&&ent1Type.equals("PROBLEM_"))
			return "1"+"||"+"averaged"+"||"+sortedConcepts.get(ent2)+"||r=\""+"TeRP"+"\"||"+sortedConcepts.get(ent1);
		else if(skip)
			return null;
